...
def add_to_cart(request, item_id):
    """ Add quantity of the product to the shopping cart"""
    ...
    if size:
        ...
        if item_id in list(cart.keys()):
            ...
            messages.success(
                request, f'Updated {product.name}  quantity to {cart[
                    item_id]}')
        else:
            cart[item_id] = quantity
...
def update_cart(request, item_id):
    """ updates quantity of the product to the shopping cart"""
