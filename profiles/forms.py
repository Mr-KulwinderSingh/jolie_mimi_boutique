...
class UserProfileForm(forms.ModelForm):
    ...
    """ 
    Customizing the UserProfile Form for a better user experience 
...
class ChangePasswordForm(PasswordChangeForm):
        ...
        def __init__(self, user, *args, **kwargs):
            ...
            #Customise rendering of help text for new_password1 field
...
def update_user_email_addresses(sender, instance, **kwargs):
    ...
    #         'default_county': 'County, State_or_Loacality',
    #     }
